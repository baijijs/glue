...
describe('load', function() {
  it('should have all files in target dir as tree structure and required', function() {
    ...
    expect(result).to.have.deep.property('controllers.v1.users_api');
    expect(result).to.have.deep.property('controllers.v1.roles_api');
    expect(result).to.have.deep.property('entities.v1');
    expect(result).to.have.deep.property('entities.v1.user_entity');
    expect(result).to.have.deep.property('entities.v1.role_entity');
